  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6">
      <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Create a New Article</h1>
          <p className="text-gray-300">Write and publish your next great article</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="title" className="text-sm font-medium text-gray-300">Article Title</Label>
            <Input
              id="title"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              >
                ...
                <option value="life" className="bg-gray-900">Life</option>
                <option value="stories" className="bg-gray-900">Stories</option>
              </select>
            ...
            <div className="space-y-2">
              ...
              {formState.errors.featuredImage && <span className="text-red-400 text-sm">{formState.errors.featuredImage[0]}</span>}
            </div>
          </div>
